...
> **Windows users:** use `python local_node.py` in a regular terminal (not WSL). Ollama must be installed and running first.
...
Then open the MeshMind web app: **[meshmind-1.onrender.com](https://meshmind-1.onrender.com)** ← replace with your hosted URL
...
- Make sure `python local_node.py start` is running in a terminal
- Make sure Ollama is running (`ollama serve`)

**No models in the dropdown**
- You need at least one chat model. Run `python local_node.py models` to install one.
